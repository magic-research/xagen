...
import torch
from training.face.networks_stylegan2 import Conv2dLayer, SynthesisLayer, ToRGBLayer
from torch_utils.ops import upfirdn2d
from torch_utils import persistence
from torch_utils import misc

from training.face.networks_stylegan2 import SynthesisBlock
import numpy as np
from training.face.networks_stylegan3 import SynthesisLayer as AFSynthesisLayer
...
class SynthesisBlockNoUp(torch.nn.Module):
    def __init__(self,
        ...
        fused_modconv_default   = True,         # Default value of fused_modconv. 'inference_only' = True for inference, False for training.face.
