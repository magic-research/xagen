...
intrinsics_dry_run = torch.tensor([[25.0,  0.0, 0.5],
                                    [0.0, 25.0, 0.5],
                                    [0.0, 0.0, 1.0]])

camera2world_dry_run = torch.tensor([[ 0.9742,  0.0587, -0.2176,  1.7069],
                                    [ 0.0242, -0.9870, -0.1585,  1.4871],
                                    [-0.2241,  0.1493, -0.9630,  7.5306],
