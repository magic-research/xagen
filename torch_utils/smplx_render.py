...
from torch_utils import render_utils as util
...
class SMPLXRender(nn.Module):
    def __init__(self, image_size, obj_filename, uv_size=256, rasterizer_type='pytorch3d'):
        ...
        colors = torch.tensor([123, 191, 212])[None, None, :].repeat(1, faces.max()+1, 1).float()/255.
